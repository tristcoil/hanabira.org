...
app.post("/d-api/v1/verb-conjugation", async (req, res) => {
  try {
    const { userPrompt } = req.body;
    const response = await handleOpenAIRequest(userPrompt, "verb-conjugation");
    res.send(response);
  } catch (error) {
    res.status(400).send({ error: error.message });
  }
...
app.post("/d-api/v1/word-similarity", async (req, res) => {
  try {
    const { userPrompt } = req.body;
    const response = await handleOpenAIRequest(userPrompt, "word-similarity");
    res.send(response);
  } catch (error) {
    res.status(400).send({ error: error.message });
  }
...
app.post("/d-api/v1/synonyms", async (req, res) => {
  try {
    const { userPrompt } = req.body;
    const response = await handleOpenAIRequest(userPrompt, "synonyms");
    res.send(response);
  } catch (error) {
    res.status(400).send({ error: error.message });
  }
...
app.post("/d-api/v1/antonyms", async (req, res) => {
  try {
    const { userPrompt } = req.body;
    const response = await handleOpenAIRequest(userPrompt, "antonyms");
    res.send(response);
  } catch (error) {
    res.status(400).send({ error: error.message });
  }
...
app.post("/d-api/v1/hypernyms", async (req, res) => {
  try {
    const { userPrompt } = req.body;
    const response = await handleOpenAIRequest(userPrompt, "hypernyms");
    res.send(response);
  } catch (error) {
    res.status(400).send({ error: error.message });
  }
...
app.post("/d-api/v1/hyponyms", async (req, res) => {
  try {
    const { userPrompt } = req.body;
    const response = await handleOpenAIRequest(userPrompt, "hyponyms");
    res.send(response);
  } catch (error) {
    res.status(400).send({ error: error.message });
  }
...
app.post("/d-api/v1/collocations", async (req, res) => {
  try {
    const { userPrompt } = req.body;
    const response = await handleOpenAIRequest(userPrompt, "collocations");
    res.send(response);
  } catch (error) {
    res.status(400).send({ error: error.message });
  }
...
app.post("/d-api/v1/part-of-speech", async (req, res) => {
  try {
    const { userPrompt } = req.body;
    const response = await handleOpenAIRequest(userPrompt, "part-of-speech");
    res.send(response);
  } catch (error) {
    res.status(400).send({ error: error.message });
  }
...
app.post("/d-api/v1/idioms", async (req, res) => {
  try {
    const { userPrompt } = req.body;
    const response = await handleOpenAIRequest(userPrompt, "idioms");
    res.send(response);
  } catch (error) {
    res.status(400).send({ error: error.message });
  }
