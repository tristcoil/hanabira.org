...
// curl -X GET http://localhost:8000/get-transcript?url=https://www.youtube.com/watch?v=mjzZ5i9i2rY&lang=jp
...
//       lang: "ja", // Specify the language code for Japanese
//     });
//
...
//
//     res.status(200).json({ status: "success", transcript: transRes });
//   } catch (error) {
