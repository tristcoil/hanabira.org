...
const HomePage = () => {
  ...
  // // Effect to load the initial data and pre-populate user ID
  // useEffect(() => {
  //   // Get query parameters
        ...
        {isOpen && (
          <div className="mt-2 p-4 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 rounded-lg shadow transition-all duration-300 ease-in-out">
            <p className="text-gray-700 dark:text-gray-300 mb-4 text-center">
              We are using the <strong>GPT4o mini</strong> model, which is
              cost-effective but basic. It splits content by individual words
              rather than logical phrases.
            </p>
            <p className="text-gray-700 dark:text-gray-300 mb-4 text-center">
              We achieved way better results with <strong>GPT 4o</strong> model.
            </p>
...
//   // State for form inputs
//   const [sentence, setSentence] = useState("");
//   const [language, setLanguage] = useState("Korean"); // Default language
//   const [userId, setUserId] = useState("");
...
//     // Set the initial sentence based on the default language
//     setSentence(exampleSentences[language]);
...
//   // State for form inputs
//   const [sentence, setSentence] = useState(
//     "저는 비 오는 일요일 오후에 둠 메탈을 듣는 것을 좋아해요."
//   );
//   const [language, setLanguage] = useState("Korean"); // Default language
//   const [userId, setUserId] = useState("");
